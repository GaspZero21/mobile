...
/// 0=Home  1=Notifications  2=Add  3=Chat  4=Profile
    ...
    return SizedBox(
      ...
      child: LayoutBuilder(builder: (context, constraints) {
        ...
        return Stack(clipBehavior: Clip.none, children: [
          ...
          // ── Notch background
          Positioned(
            bottom: 0, left: circleX - 40,
            child: Container(
              width: 80, height: 80,
              decoration: const BoxDecoration(
                  color: kSand, shape: BoxShape.circle),
            ),
          ),

          // ── Active circle
          Positioned(
            bottom: 8, left: circleX - 32,
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                    child: _iconFor(widget.currentIndex, true)),
              ),
            ),
          ),
        ]);
  ...
  Widget _iconFor(int index, bool active) {
    ...
    switch (index) {
      ...
      case 2:
        ...
        break;
      case 3:
        icon = const Icon(Icons.chat_bubble_outline, color: c, size: sz);
        break;
      case 4:
